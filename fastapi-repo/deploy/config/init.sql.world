...
--
-- Host: 127.0.0.1    Database: fastapidb
-- ------------------------------------------------------
...
--
-- Current Database: `fastapidb`
--

/*!40000 DROP DATABASE IF EXISTS `fastapidb`*/;

CREATE DATABASE `fastapidb` DEFAULT CHARACTER SET utf8mb4;
...
--
-- Dumping events for database 'fastapidb'
--

--
-- Dumping routines for database 'fastapidb'
--
